/**
 * @file mindstreamer_bci_streaming.ino
 * @brief Complete EEG acquisition and control using MindStreamer library
 * @author Dr. Hafed-Eddine Bendib
 * @version 2.0.0
 * 
 * Features:
 * - 8-channel EEG acquisition (250 SPS)
 * - Runtime output mode switching (TEXT, BINARY, OPENEEG, DEBUG, VOID)
 * - Channel power on/off via serial commands (1-8 disable, a-i enable)
